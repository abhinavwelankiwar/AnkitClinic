...
this.patientId = this.loginService.loggedInUserId;
  ...
  book() {
    ...
    this.appointmentService.bookWithoutAgent(appointment).subscribe((res) => {
      console.log("SUCCESS");
  ...
  bookWithAgent() {
      ...
      this.appointmentService.bookByAgent(appointment).subscribe((res) => {
        console.log("SUCCESS");
        alert('Your appointment request has been sent successfully');
